...
('iPhone 15', 'Smartphone Apple iPhone 15 128GB', 4500000.00, 'IPH15-128', 1),
...
('Balón fútbol', 'Balón de fútbol profesional', 120000.00, 'BAL-FUT-PRO', 4),
('Raqueta tennis', 'Raqueta de tenis Wilson Pro Staff', 450000.00, 'RQT-TEN-WPS', 4),
('El Quijote', 'Novela de Miguel de Cervantes', 45000.00, 'LIB-QUIJOTE', 5),
('Atlas Mundial', 'Atlas geográfico del mundo', 85000.00, 'ATL-MUNDO-2024', 5),
('Muñeca Barbie', 'Muñeca Barbie clásica', 65000.00, 'BARBIE-CLASSIC', 6),
('Lego Creator', 'Set de construcción Lego Creator 3-en-1', 280000.00, 'LEGO-CRE-3IN1', 6),
('Aceite motor', 'Aceite sintético 5W-30 1L', 35000.00, 'ACE-MOT-5W30', 7),
('Filtro aire', 'Filtro de aire para Toyota Corolla', 25000.00, 'FLT-AIR-TCOR', 7),
('Crema hidratante', 'Crema hidratante facial 50ml', 45000.00, 'CRM-HID-FAC50', 8),
('Vitamina C', 'Suplemento vitamina C 500mg', 25000.00, 'VIT-C-500MG', 8),
('Cuaderno A4', 'Cuaderno rayado 100 hojas', 8000.00, 'CUAD-A4-100H', 9),
('Bolígrafo BIC', 'Bolígrafo azul BIC cristal', 2000.00, 'BOL-BIC-AZUL', 9),
('Tijeras podar', 'Tijeras de podar profesionales', 35000.00, 'TJR-POD-PROF', 10),
('Manguera jardín', 'Manguera extensible 20m', 45000.00, 'MNG-JRD-20M', 10);
...
(4, 9), (4, 10), (5, 11), (5, 12), (6, 13), (6, 14), (7, 15),
(7, 16), (8, 17), (8, 18), (9, 19), (9, 20), (10, 21), (10, 22);
...
-- Insertar usuarios
INSERT INTO user_table (username, email, password, first_name, last_name, phone, address) VALUES
