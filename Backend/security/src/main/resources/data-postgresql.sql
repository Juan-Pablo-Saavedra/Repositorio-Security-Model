-- Inicialización de datos para PostgreSQL
-- Este archivo se ejecuta automáticamente cuando se usa el perfil PostgreSQL
...
(1, 'IN'::movement_type, 10, 'Stock inicial', 'system'),
(2, 'IN'::movement_type, 25, 'Stock inicial', 'system'),
(3, 'IN'::movement_type, 50, 'Stock inicial', 'system'),
(4, 'IN'::movement_type, 15, 'Stock inicial', 'system'),
(5, 'IN'::movement_type, 8, 'Stock inicial', 'system');

-- Insertar órdenes de ejemplo
INSERT INTO "order" (client_id, total, status, created_by) VALUES
(1, 1329.98, 'CONFIRMED'::order_status, 'system'),
(2, 65.98, 'PENDING'::order_status, 'system');
