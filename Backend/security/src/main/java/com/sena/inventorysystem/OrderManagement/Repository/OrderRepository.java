...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findByTotalRange(@Param("minTotal") Double minTotal, @Param("maxTotal") Double maxTotal);

    List<Order> findByClientIdAndStatus(Long clientId, Order.OrderStatus status);
}